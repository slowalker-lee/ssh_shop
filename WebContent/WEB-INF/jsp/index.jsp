			...
			<div id="hotProduct" class="hotProduct clearfix">
					...
					<ul class="tabContent">
						<s:iterator value="#session.hList" var="p">
							<li class="current">
								<a href="${pageContext.request.contextPath }/product_findByPid?pid=<s:property value="#p.pid"/>"><img src="${pageContext.request.contextPath }/<s:property value="#p.image"/>" target="_blank"></a>
							</li>
						</s:iterator> 
					</ul>
						...
						<ul class="tabContent" style="display: none;">
								<s:iterator value="newProducts" var="p">
									...
									<li>
										<a target="_blank" href="${pageContext.request.contextPath }/product_findByPid?pid=<s:property value="#p.pid"/>"><img src="${pageContext.request.contextPath }/<s:property value="#p.image"/>" style="display: block;"></a>
									</li>
								</s:iterator>
						</ul>
			</div>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;" id="chulai">
									<s:iterator value="#request.newProduct" var="p">
						...
						<ul class="tabContent" id="where me" style="display: none;">
